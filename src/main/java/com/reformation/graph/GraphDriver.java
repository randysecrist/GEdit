...
import com.reformation.graph.algorithms.SpanningTree;
import com.reformation.graph.gui.GEdit;
...
public class  GraphDriver {
    ...
    private static final String DEFAULT_DATA_WRAPPER = "com.reformation.graph.StringObj";
    private Data dataSpawn = null;
    private static String namedWrapper;

    public static void main(String[] argv) {
        namedWrapper = GEdit.processArgs(argv, "com.reformation.graph.StringObj");
